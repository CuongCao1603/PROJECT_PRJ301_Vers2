<%-- 
    Document   : Menu
    Created on : Jul 7, 2022, 3:52:01 AM
    Author     : HLC_2021
--%>
    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse justify-content-end" id="navbarsExampleDefault">
            <ul class="navbar-nav m-auto">
                ...
                <!--phân quyền truy cập sử dụng session-->
                <c:if test="${sessionScope.acc!=null}">

                    <!--Gọi đến user trong session-->
                    <li class="nav-item">
                        <a class="nav-link" href="#">Hello ${sessionScope.acc.user}</a>
                    </li>

                    <!--Gọi servlet có đường dẫn là logout-->
                    <li class="nav-item">
            ...
            <form action="search" method="post" class="form-inline my-2 my-lg-0">
                <div class="input-group input-group-sm">
                    <!--oninput truyền vào giá trị khi có sự kiện nhập diễn ra ngay lập tức, nó gọi tới hàm this trong javasrcipt-->
